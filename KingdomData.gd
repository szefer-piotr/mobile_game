...
static func kingdom1_buildings() -> Dictionary:
        return {
                "Peon Hut": {"level": 0, "costs": [50, 100, 150, 250, 400]},
                "Card Shrine": {"level": 0, "costs": [60, 120, 240, 480, 960]},
                "Barracks": {"level": 0, "costs": [80, 160, 320, 640, 1280]},
                "Farm": {"level": 0, "costs": [40, 80, 160, 320, 640]},
                "Blacksmith": {"level": 0, "costs": [90, 180, 360, 720, 1440]},
                "Archery Range": {"level": 0, "costs": [70, 140, 280, 560, 1120]},
                "Stable": {"level": 0, "costs": [75, 150, 300, 600, 1200]},
